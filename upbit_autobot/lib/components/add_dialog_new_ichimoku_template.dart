...
class AddDialogNewIchimokuTemplate extends StatefulWidget {
  const AddDialogNewIchimokuTemplate({super.key});

  @override
  State<AddDialogNewIchimokuTemplate> createState() =>
      _AddDialogNewIchimokuTemplateState();
}

class _AddDialogNewIchimokuTemplateState
    extends State<AddDialogNewIchimokuTemplate>
